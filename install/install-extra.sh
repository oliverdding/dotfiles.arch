...
install_package jdk-openjdk jre-openjdk openjdk-doc openjdk-src scala scala-sources scala-docs gradle sbt
install_package cargo-flamegraph cargo-bloat cargo-update cargo-edit rustup
